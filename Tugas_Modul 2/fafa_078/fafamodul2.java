...
class NovelLama extends Novel {
    ...
    NovelLama(String judul, int tahunTerbit, String penulis, String kategoriNovel, String statusPeminjaman){
        super(judul, tahunTerbit, penulis, kategoriNovel, statusPeminjaman);
    }
    void info(){
...
class NovelBaru extends Novel {
    ...
    NovelBaru(String judul, int tahunTerbit, String penulis, String kategoriNovel, String statusPeminjaman){
        super(judul, tahunTerbit, penulis, kategoriNovel, statusPeminjaman);
    }
    void info(){
...
public class fafamodul2 {
    public static void main(String[] args) {
        ...
        if(tahun <= batas){
            NovelLama novel = new NovelLama(judul, tahun, penulis, kategori, status);
            System.out.println("\nData Novel");
            novel.tampilNovel();
            novel.info();
        }else{
            NovelBaru novel = new NovelBaru(judul, tahun, penulis, kategori, status);
            System.out.println("\nData Novel");
            novel.tampilNovel();
            novel.info();
        }
