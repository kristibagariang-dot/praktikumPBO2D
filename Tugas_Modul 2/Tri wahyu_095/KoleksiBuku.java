...
public class Perpustakaan {
    public static void main(String[] args) {
        ...
        Buku b1 = new Buku("Buku mengambar anime", 2025, "Tri wahyu", "Design komunikasi visual", "pendidikan", 12);

        NovelCek n1 = new NovelCek("4 putri cinta", 2023, "Yuya", "Romantis", "Dipinjam");
