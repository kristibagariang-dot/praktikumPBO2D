...
class Novel extends Koleksi {
    ...
    Novel(String judul, int tahunTerbit, String penulis, String 
            kategoriNovel, String statusPeminjaman){
        super(judul, tahunTerbit);
...
public class Main1 {
    public static void main(String[] args) {
        ...
        Buku buku = new Buku(judulBuku, tahunBuku, 
                pengarang, penerbit, kategoriBuku, stok);
        ...
        Novel novel = new Novel(judulNovel, tahunNovel, 
                penulis, kategoriNovel, status);
